...
- **`aps_mcp.py`** — 37 tools for navigation, folder/file operations, permission auditing, bulk user management, hub-level directory onboarding, and bulk folder reorg
...
All 37 tools are registered via `@app.call_tool`. The key layers:
