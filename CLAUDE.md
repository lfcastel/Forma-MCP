...
- **`aps_mcp.py`** — 32 tools for navigation, folder/file operations, permission auditing, bulk user management, and bulk folder reorg
...
All 32 tools are registered via `@app.call_tool`. The key layers:
